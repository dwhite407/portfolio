export const shortBio =
  "Drew White — CS student at Indiana University (Luddy School), currently a Software Engineer Intern at Eli Lilly. I build full-stack web apps, mostly JavaScript/TypeScript, React, and Node. Type `cat about.md` or click About for the longer version.";

export const aboutMarkdown = `# whoami
...
- Full-stack web development — JavaScript/TypeScript, React, Node.js, Express
- Comfortable across the stack, from REST APIs and SQL databases to real-time UIs with Socket.IO
- Also work in Python, C++, and Kotlin, with some Django and Jetpack Compose experience
...
- Eli Lilly Career Planning Conference Capture the Flag — 2nd Place (October 2025)
- BDPA Indianapolis Hackathon — First Place, Best Design Award (November 2025)
- Eli Lilly and Company Hackathon — Most Creative Award (June 2026)
